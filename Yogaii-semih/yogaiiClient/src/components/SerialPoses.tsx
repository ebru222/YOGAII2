...
export default function SeriesBuilder() {
    ...
    const handleDurationChange = (pose, value) => {
    ...
    const handleEditPose = (pose, currentDuration) => {
        setEditingPose(pose);
        setEditValue(currentDuration);
    };
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    onMouseOver={(e) => e.target.style.color = '#ffdf00'}
            ...
            <div style={{ textAlign: 'center' }}>
                <button onClick={handleStartSeries} style={{
                    ...
                    onMouseOut={(e) => e.target.style.transform = 'scale(1)'}>Seriye Başla</button>
            </div>
        </div>
    );
}